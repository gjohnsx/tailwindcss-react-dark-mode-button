      ...
      <div className="relative max-w-xl mx-auto px-4 sm:px-6 lg:px-8 lg:max-w-7xl">
        ...
        >
          <defs>
            ...
            >
              <rect x={0} y={0} width={4} height={4} className="text-gray-200 dark:text-opacity-5" fill="currentColor" />
            </pattern>
          </defs>
        ...
        <div className="relative">
          <h2 className="text-center text-3xl leading-8 font-extrabold tracking-tight text-gray-900 dark:text-slate-100 sm:text-4xl">
            A better way to send money
          </h2>
          <p className="mt-4 max-w-3xl mx-auto text-center text-xl text-gray-500 dark:text-slate-300">
        ...
        <div className="relative mt-12 lg:mt-24 lg:grid lg:grid-cols-2 lg:gap-8 lg:items-center">
          <div className="relative">
            <h3 className="text-2xl font-extrabold text-gray-900 dark:text-slate-50 tracking-tight sm:text-3xl">
              ...
              {transferFeatures.map((item) => (
                <div key={item.id} className="relative">
                  <dt>
                    ...
                    <p className="ml-16 text-lg leading-6 font-medium text-gray-900 dark:text-slate-100">{item.name}</p>
                  </dt>
                  <dd className="mt-2 ml-16 text-base text-gray-500 dark:text-slate-300">{item.description}</dd>
                </div>
              ))}
            </dl>
          </div>
        ...
        <div className="relative mt-12 sm:mt-16 lg:mt-24">
          <div className="lg:grid lg:grid-flow-row-dense lg:grid-cols-2 lg:gap-8 lg:items-center">
            <div className="lg:col-start-2">
              <h3 className="text-2xl font-extrabold text-gray-900 dark:text-slate-50 tracking-tight sm:text-3xl">Always in the loop</h3>
              <p className="mt-3 text-lg text-gray-500 dark:text-slate-300">
