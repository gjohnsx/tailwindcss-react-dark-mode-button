export default function CTA() {
    return (
      <div className="relative py-16 bg-white dark:bg-slate-700">
        <div className="hidden absolute top-0 inset-x-0 h-1/2 bg-gray-50 dark:bg-slate-700 lg:block" aria-hidden="true" />
        <div className="max-w-7xl mx-auto bg-indigo-600 lg:bg-transparent lg:px-8">
          <div className="lg:grid lg:grid-cols-12">
            <div className="relative z-10 lg:col-start-1 lg:row-start-1 lg:col-span-4 lg:py-16 lg:bg-transparent">
              <div className="absolute inset-x-0 h-1/2 bg-gray-50 dark:bg-slate-700 lg:hidden" aria-hidden="true" />
